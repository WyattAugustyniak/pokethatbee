    ...
    function preload() {
      ...
      sprite_sheet = loadSpriteSheet('assets/bee1.png', 32, 32, 8);
      ...
      sprite_sheet = loadSpriteSheet('assets/poke.png', 32, 37, 7);
      eat_animation = loadAnimation(sprite_sheet);

      sprite_sheet = loadSpriteSheet('assets/bee1.png', 32, 32, 10);
      hungry_animation = loadAnimation(sprite_sheet);

      sprite_sheet = loadSpriteSheet('assets/die.png', 32, 35, 12);
      barf_animation = loadAnimation(sprite_sheet);

      sprite_sheet = loadSpriteSheet('assets/barf.png', 32, 36, 12);
      die_animation = loadAnimation(sprite_sheet);

      //load static images
      bg_image = loadImage("assets/bg1.png");
      feed_icon = loadImage("assets/feed_button.png");
      feed_icon_roll = loadImage("assets/feed_button_roll.png");

      //load sound
      eat_sound = loadSound("assets/barf.wav");
      barf_sound = loadSound("assets/die.wav");
